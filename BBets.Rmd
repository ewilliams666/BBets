...
In this graph, Brownlow wins $238.
...
```{r}
numClass=35
# my guess for the fair odds is $xxx: $1
odds = 4.33
countoDo= 637
saveBank = vector('numeric')
for (k in 1: 40){
...
Brownlow is making an average of $282 for 2:1. To make the game fair, the odds should be 4.33:1. 
...
In order to make the 2:1 bet fair, the amount of students in the class would have to be `r numClass` .
